...
api.editor.defineTheme('forgedeck-light', {
  base: 'vs',
  inherit: true,
  rules: [
    { token: '', foreground: '1a2b25' },
    { token: 'comment', foreground: '6b7d75', fontStyle: 'italic' },
    { token: 'keyword', foreground: '1a8a5c' },
    { token: 'string', foreground: '8a6a14' },
    { token: 'string.key', foreground: '8a6a14' },
    ...
    { token: 'delimiter', foreground: '6b7d75' },
    { token: 'tag', foreground: '1a8a5c' },
    { token: 'attribute.name', foreground: '8a6a14' },
    { token: 'attribute.value', foreground: '1a2b25' },
    { token: 'variable.predefined', foreground: '0f766e' },
    { token: 'metatag', foreground: '6b7d75' },
    { token: 'key', foreground: '8a6a14' },
  ],
  colors: {
    'editor.background': '#eef3f0',
    'editor.foreground': '#1a2b25',
    'editorGutter.background': '#eef3f0',
    'editorLineNumber.foreground': '#8a9a93',
    'editorLineNumber.activeForeground': '#1a8a5c',
    'editorCursor.foreground': '#1a8a5c',
    'editor.selectionBackground': '#1a8a5c33',
    'editor.inactiveSelectionBackground': '#1a8a5c1a',
    'editor.lineHighlightBackground': '#00000008',
    'editor.lineHighlightBorder': '#00000000',
    'editorIndentGuide.background1': '#00000014',
    'editorIndentGuide.activeBackground1': '#00000029',
    'editorWidget.background': '#ffffff',
    'editorWidget.border': '#d5ded9',
    'editorOverviewRuler.border': '#00000000',
    'editor.findMatchBackground': '#1a8a5c4d',
    'editor.findMatchHighlightBackground': '#1a8a5c33',
    'editorBracketMatch.background': '#1a8a5c26',
    'editorBracketMatch.border': '#1a8a5c66',
    'scrollbarSlider.background': '#0000001c',
    'scrollbarSlider.hoverBackground': '#00000030',
    'scrollbarSlider.activeBackground': '#1a8a5c33',
  },
});
