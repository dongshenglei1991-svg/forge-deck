# bf1e496b-572f-451d-b5d4-7ba675b40104 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `ai-tool-launcher.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `ai-tool-launcher.html`
...
- A single self-contained `ai-tool-launcher.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `ai-tool-launcher.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `ai-tool-launcher-preview.png`

## Coding checklist for AI tools
1. Inspect `ai-tool-launcher.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
